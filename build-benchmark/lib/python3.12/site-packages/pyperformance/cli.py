...
def parse_args():
    ...
    cmd.add_argument("--process",
                     help="number of processes to spawn for this benchmark (default: 20)")

    cmd.add_argument("--values",
                     help="number of values per process (default: 3)")

    cmd.add_argument("--loops",
                     help="number of loops per value, 0 means automatic calibration (default: 0)")

    cmd.add_argument("-w", "--warmup",
                     help="number of skipped values per run used to warmup")

    cmd.add_argument("--tracemalloc", action='store_true',
                     help="enable tracemalloc for the benchmark")
