...
build_time_vars = {'ABIFLAGS': 'd',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/home/qianhuiwang/cpython/val-hybrid/bin',
 'BINLIBDEST': '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12',
 'BLDLIBRARY': 'libpython3.12d.a',
 'BLDSHARED': 'cc -pthread -shared -mabi=aapcs -L/usr/local64/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'aarch64-unknown-freebsd',
 'BUILD_SCRIPTS_DIR': 'build/scripts-3.12',
 'BYTESTR_DEPS': '\\',
 'CC': 'cc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-overflow -DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Og -Wall '
           '-mabi=aapcs',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/usr/local64/include -I/usr/include',
 'CONFIGURE_LDFLAGS': '-mabi=aapcs -L/usr/local64/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'CFLAGS=-mabi=aapcs' 'CPPFLAGS=-I/usr/local64/include "
                "-I/usr/include' 'PKG_CONFIG=/usr/local64/bin/pkg-config' "
                "'LDFLAGS=-mabi=aapcs -L/usr/local64/lib' '--with-pydebug' "
 ...
 'CONFINCLUDEDIR': '/home/qianhuiwang/cpython/val-hybrid/include',
 'CONFINCLUDEPY': '/home/qianhuiwang/cpython/val-hybrid/include/python3.12d',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/qianhuiwang/cpython/val-hybrid/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/qianhuiwang/cpython/val-hybrid/lcov-report',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include '
             '-I/usr/local64/include -I/usr/include',
 'CXX': 'c++ -pthread',
 'DEEPFREEZE_C': 'Python/deepfreeze/deepfreeze.c',
 'DEEPFREEZE_DEPS': '../Tools/build/deepfreeze.py _bootstrap_python '
                    '../Programs/_freeze_module.py \\',
 'DEEPFREEZE_OBJS': 'Python/deepfreeze/deepfreeze.o',
 'DESTDIRS': '/home/qianhuiwang/cpython/val-hybrid '
             '/home/qianhuiwang/cpython/val-hybrid/lib '
             '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12 '
             '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12/lib-dynload',
 'DESTLIB': '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/home/qianhuiwang/cpython/val-hybrid/bin/python3.12d',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-312d.so',
 'FILEMODE': 644,
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'aarch64-unknown-freebsd',
 'INCLDIRSTOMAKE': '/home/qianhuiwang/cpython/val-hybrid/include '
                   '/home/qianhuiwang/cpython/val-hybrid/include '
                   '/home/qianhuiwang/cpython/val-hybrid/include/python3.12d '
                   '/home/qianhuiwang/cpython/val-hybrid/include/python3.12d',
 'INCLUDEDIR': '/home/qianhuiwang/cpython/val-hybrid/include',
 'INCLUDEPY': '/home/qianhuiwang/cpython/val-hybrid/include/python3.12d',
 ...
 'LDVERSION': '3.12d',
 'LIBC': '',
 'LIBDEST': '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12',
 'LIBDIR': '/home/qianhuiwang/cpython/val-hybrid/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I../Modules/expat -fno-strict-overflow '
                    '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Og -Wall -mabi=aapcs '
                    '-std=c11 -Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I../Include/internal -IObjects '
                    '-IInclude -IPython -I. -I../Include '
                    '-I/usr/local64/include -I/usr/include -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   '-fno-strict-overflow -DDYNAMIC_ANNOTATIONS_ENABLED=1 -g '
                   '-Og -Wall -mabi=aapcs -std=c11 '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I../Include/internal -IObjects -IInclude -IPython -I. '
                   '-I../Include -I/usr/local64/include -I/usr/include -fPIC',
 'LIBHACL_HEADERS': '\\',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/qianhuiwang/cpython/val-hybrid/lib/pkgconfig',
 'LIBPL': '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12/config-3.12d',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'freebsd15',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/qianhuiwang/cpython/val-hybrid/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Modules/makesetup',
 'MANDIR': '/home/qianhuiwang/cpython/val-hybrid/share/man',
 ...
 'MODULE_READLINE_CFLAGS': '-I/usr/local64/include',
 'MODULE_READLINE_LDFLAGS': '-L/usr/local64/lib -lreadline',
 ...
 'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/usr/local64/include',
 'MODULE__CTYPES_DEPS': '../Modules/_ctypes/ctypes.h',
 'MODULE__CTYPES_LDFLAGS': '-L/usr/local64/lib -lffi  -ldl',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/usr/local64/include  -I../Modules/_sqlite',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/usr/local64/lib -lsqlite3',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow '
                             '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Og -Wall '
                             '-mabi=aapcs -std=c11 '
                             '-Werror=implicit-function-declaration '
 ...
 'PY_CFLAGS': '-fno-strict-overflow -DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Og '
              '-Wall -mabi=aapcs',
 'PY_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                     '-fvisibility=hidden  -I../Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-fno-strict-overflow -DDYNAMIC_ANNOTATIONS_ENABLED=1 -g '
                   '-Og -Wall -mabi=aapcs -std=c11 '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I../Include/internal -IObjects -IInclude -IPython -I. '
                   '-I../Include -I/usr/local64/include -I/usr/include '
                   '-DPy_BUILD_CORE',
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -DDYNAMIC_ANNOTATIONS_ENABLED=1 '
                        '-g -Og -Wall -mabi=aapcs -std=c11 '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I../Include/internal -IObjects '
                        '-IInclude -IPython -I. -I../Include '
                        '-I/usr/local64/include -I/usr/include',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/home/qianhuiwang/cpython/val-hybrid/lib',
 'SCRIPT_2TO3': 'build/scripts-3.12/2to3-3.12',
 'SCRIPT_IDLE': 'build/scripts-3.12/idle3.12',
 'SCRIPT_PYDOC': 'build/scripts-3.12/pydoc3.12',
 'SETPGRP_HAVE_ARG': 1,
 'SHAREDMODS': 'Modules/array.cpython-312d.so Modules/_asyncio.cpython-312d.so '
               'Modules/_bisect.cpython-312d.so '
               'Modules/_contextvars.cpython-312d.so '
               'Modules/_csv.cpython-312d.so Modules/_heapq.cpython-312d.so '
               'Modules/_json.cpython-312d.so Modules/_lsprof.cpython-312d.so '
               'Modules/_opcode.cpython-312d.so '
               'Modules/_pickle.cpython-312d.so Modules/_queue.cpython-312d.so '
               'Modules/_random.cpython-312d.so '
               'Modules/_struct.cpython-312d.so '
               'Modules/_xxsubinterpreters.cpython-312d.so '
               'Modules/_xxinterpchannels.cpython-312d.so '
               'Modules/_zoneinfo.cpython-312d.so '
               'Modules/audioop.cpython-312d.so Modules/math.cpython-312d.so '
               'Modules/cmath.cpython-312d.so '
               'Modules/_statistics.cpython-312d.so '
               'Modules/_datetime.cpython-312d.so '
               ...
               'Modules/_codecs_hk.cpython-312d.so '
               'Modules/_codecs_iso2022.cpython-312d.so '
               'Modules/_codecs_jp.cpython-312d.so '
               'Modules/_codecs_kr.cpython-312d.so '
               'Modules/_codecs_tw.cpython-312d.so '
               'Modules/_multibytecodec.cpython-312d.so '
               'Modules/unicodedata.cpython-312d.so '
               'Modules/_crypt.cpython-312d.so Modules/fcntl.cpython-312d.so '
               'Modules/grp.cpython-312d.so Modules/mmap.cpython-312d.so '
               'Modules/nis.cpython-312d.so '
               'Modules/ossaudiodev.cpython-312d.so '
               'Modules/_posixsubprocess.cpython-312d.so '
               'Modules/resource.cpython-312d.so '
               'Modules/select.cpython-312d.so Modules/_socket.cpython-312d.so '
               'Modules/syslog.cpython-312d.so Modules/termios.cpython-312d.so '
               'Modules/_posixshmem.cpython-312d.so '
               'Modules/_multiprocessing.cpython-312d.so '
               'Modules/_ctypes.cpython-312d.so '
               'Modules/_curses.cpython-312d.so '
               ...
               'Modules/_testinternalcapi.cpython-312d.so '
               'Modules/_testcapi.cpython-312d.so '
               'Modules/_testclinic.cpython-312d.so '
               'Modules/_testimportmultiple.cpython-312d.so '
               'Modules/_testmultiphase.cpython-312d.so '
               'Modules/_testsinglephase.cpython-312d.so '
               'Modules/_ctypes_test.cpython-312d.so '
 ...
 'VERSION': '3.12',
 'VPATH': '..',
 'WASM_ASSETS_DIR': './home/qianhuiwang/cpython/val-hybrid',
 'WASM_STDLIB': './home/qianhuiwang/cpython/val-hybrid/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/home/qianhuiwang/cpython/val-hybrid',
 'abs_srcdir': '/home/qianhuiwang/cpython/val-hybrid/..',
 'datarootdir': '/home/qianhuiwang/cpython/val-hybrid/share',
 'exec_prefix': '/home/qianhuiwang/cpython/val-hybrid',
 'prefix': '/home/qianhuiwang/cpython/val-hybrid',
 'srcdir': '..'}
