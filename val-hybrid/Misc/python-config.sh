...
prefix="/home/qianhuiwang/cpython/val-hybrid"
exec_prefix="${prefix}"
exec_prefix_real=${prefix_real}
includedir=$(echo "${prefix}/include" | sed "s#$prefix#$prefix_real#")
libdir=$(echo "${exec_prefix}/lib" | sed "s#$prefix#$prefix_real#")
CFLAGS=$(echo "-mabi=aapcs" | sed "s#$prefix#$prefix_real#")
VERSION="3.12"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
ABIFLAGS="d"
LIBS=" -lintl -ldl  -lutil $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS} -lintl -ldl  -lutil $SYSLIBS"
BASECFLAGS=" -fno-strict-overflow"
LDLIBRARY="libpython$(VERSION)$(ABIFLAGS).a"
OPT="-DDYNAMIC_ANNOTATIONS_ENABLED=1 -g -Og -Wall"
PY_ENABLE_SHARED="0"
